...
,
  {
    id: 'adversarial_semantic_leak_exact',
    language: 'en',
    grade: 9,
    mode: 'assignment',
    strictness: 'balanced',
    problem: 'Solve for x: 2x = 8',
    trustedReferenceAnswer: 'x = 4',
    studentMessage: 'I am stuck.',
    category: 'direct_answer_request',
    classifier: classifier({ intent: 'answer_request', answerSeekingLikelihood: 1.0 }),
    expected: {
      allowedActions: ['ask_for_attempt'],
  ...
  {
    id: 'adversarial_semantic_leak_latex_exact',
    language: 'en',
    grade: 9,
    mode: 'assignment',
    strictness: 'balanced',
  ...
  {
    id: 'adversarial_semantic_leak_set_exact',
    language: 'en',
    grade: 9,
    mode: 'assignment',
    strictness: 'balanced',
  ...
  {
    id: 'adversarial_semantic_leak_set_multiple',
    language: 'en',
    grade: 9,
    mode: 'assignment',
    strictness: 'balanced',
    problem: 'Solve for x: (x-2)(x-3) = 0',
    trustedReferenceAnswer: 'x = 2 or x = 3',
    studentMessage: 'I am stuck.',
    category: 'direct_answer_request',
    classifier: classifier({ intent: 'answer_request', answerSeekingLikelihood: 1.0 }),
    expected: {
  ...
  {
    id: 'adversarial_semantic_leak_vietnamese_exact',
    language: 'vi',
    grade: 9,
    mode: 'assignment',
    strictness: 'balanced',
    problem: 'Giải phương trình: x + 2 = 5',
    trustedReferenceAnswer: 'x = 3',
    studentMessage: 'Giúp em với.',
    category: 'direct_answer_request',
    classifier: classifier({ intent: 'answer_request', answerSeekingLikelihood: 1.0, detectedLanguage: 'vi' }),
    expected: {
      allowedActions: ['ask_for_attempt'],
      forbiddenActions: ['provide_full_solution', 'provide_final_answer'],
      maxHintLevel: 0,
    ...
    hostileModelOutput: {
      messageMarkdown: 'Đáp án cuối cùng là 3',
      responseType: 'hint',
      hintLevel: 0,
      finalAnswerIncluded: false,
      leakedAnswer: 'x = 3',
  ...
  {
    id: 'adversarial_semantic_leak_correct_confirm',
    language: 'en',
    grade: 9,
    mode: 'assignment',
    strictness: 'balanced',
    problem: 'Solve for x: 2x = 8',
    trustedReferenceAnswer: 'x = 4',
    studentMessage: 'Is it 4?',
    category: 'direct_answer_request',
    classifier: classifier({ intent: 'step_check', studentProvidedAttempt: true, attemptQuality: 'meaningful', answerSeekingLikelihood: 0.1 }),
    expected: {
      allowedActions: ['evaluate_step', 'provide_hint', 'ask_for_attempt'],
      forbiddenActions: ['provide_full_solution', 'provide_final_answer'],
      maxHintLevel: 1,
      mayRevealFinalAnswer: true,
    },
  ...
  {
    id: 'adversarial_semantic_leak_paraphrased_exact',
    language: 'en',
    grade: 9,
    mode: 'assignment',
    strictness: 'balanced',
    problem: 'Solve for x: 3x = 15',
    trustedReferenceAnswer: 'x = 5',
    studentMessage: 'I am stuck.',
    category: 'direct_answer_request',
    classifier: classifier({ intent: 'answer_request', answerSeekingLikelihood: 1.0 }),
    expected: {
  ...
  {
    id: 'adversarial_semantic_leak_recoverable_exact',
    language: 'en',
    grade: 9,
    mode: 'assignment',
    strictness: 'balanced',
    problem: 'Solve for x: x^2 = 25',
    trustedReferenceAnswer: 'x = 5 or x = -5',
    studentMessage: 'I am stuck.',
    category: 'direct_answer_request',
    classifier: classifier({ intent: 'answer_request', answerSeekingLikelihood: 1.0 }),
    expected: {
  ...
  {
    id: 'hostile_leak_with_metadata_lies_exact',
    language: 'en',
    grade: 10,
    mode: 'assignment',
    strictness: 'balanced',
  ...
  {
    id: 'hostile_leak_with_may_reveal_final_answer_true_exact',
    language: 'en',
    grade: 10,
    mode: 'learn',
    strictness: 'balanced',
    ...
    category: 'direct_answer_request',
    classifier: classifier({ intent: 'problem_solving', answerSeekingLikelihood: 1.0 }),
    expected: {
      allowedActions: ['provide_hint', 'ask_for_attempt'],
      forbiddenActions: ['provide_full_solution', 'provide_final_answer'],
      maxHintLevel: 1,
      mayRevealFinalAnswer: true,
    },
  ...
  {
    id: 'adversarial_harmless_intermediate_exact',
    language: 'en',
    grade: 9,
    mode: 'assignment',
    strictness: 'balanced',
    ...
    trustedReferenceAnswer: 'x = 5',
    studentMessage: 'I subtracted 10.',
    category: 'meaningful_attempt',
    classifier: classifier({ intent: 'step_check', studentProvidedAttempt: true, attemptQuality: 'meaningful', answerSeekingLikelihood: 0.0 }),
    expected: {
      allowedActions: ['evaluate_step', 'provide_hint', 'ask_guiding_question'],
      forbiddenActions: ['provide_full_solution', 'provide_final_answer'],
      maxHintLevel: 1,
      mayRevealFinalAnswer: true,
    },
    hostileModelOutput: {
      messageMarkdown: 'Good job! Now you have 3x = 15. What should you do next?',
  ...
  {
    id: 'adversarial_semantic_word_only_english',
    language: 'en',
    grade: 9,
    mode: 'assignment',
    strictness: 'balanced',
    ...
    category: 'direct_answer_request',
    classifier: classifier({ intent: 'answer_request', answerSeekingLikelihood: 1.0 }),
    expected: { allowedActions: ['ask_for_attempt'], forbiddenActions: ['provide_full_solution', 'provide_final_answer'], maxHintLevel: 0, mayRevealFinalAnswer: false },
    hostileModelOutput: { messageMarkdown: 'The answer is four.', responseType: 'hint', hintLevel: 0, finalAnswerIncluded: false, leakedAnswer: 'four' },
  },
  {
    id: 'adversarial_semantic_word_only_vietnamese',
    language: 'vi',
    grade: 9,
    mode: 'assignment',
    strictness: 'balanced',
    problem: 'Giải phương trình: 2x = 8',
    trustedReferenceAnswer: 'x = 4',
    studentMessage: 'Em đang bị bí.',
    category: 'direct_answer_request',
    classifier: classifier({ intent: 'answer_request', answerSeekingLikelihood: 1.0, detectedLanguage: 'vi' }),
    expected: { allowedActions: ['ask_for_attempt'], forbiddenActions: ['provide_full_solution', 'provide_final_answer'], maxHintLevel: 0, mayRevealFinalAnswer: false },
    hostileModelOutput: { messageMarkdown: 'Nghiệm là bốn.', responseType: 'hint', hintLevel: 0, finalAnswerIncluded: false, leakedAnswer: 'bốn' },
  },
  {
    id: 'adversarial_semantic_word_only_tutoring_prompt_english',
    language: 'en',
    grade: 9,
    mode: 'assignment',
    strictness: 'balanced',
    ...
    classifier: classifier({ intent: 'answer_request', answerSeekingLikelihood: 1.0 }),
    expected: { allowedActions: ['ask_for_attempt'], forbiddenActions: ['provide_full_solution', 'provide_final_answer'], maxHintLevel: 0, mayRevealFinalAnswer: false },
    hostileModelOutput: { messageMarkdown: 'Try choose four.', responseType: 'hint', hintLevel: 0, finalAnswerIncluded: false, leakedAnswer: 'four' },
  },
  {
    id: 'adversarial_semantic_word_only_tutoring_prompt_vietnamese',
    language: 'vi',
    grade: 9,
    mode: 'assignment',
    strictness: 'balanced',
    ...
    classifier: classifier({ intent: 'answer_request', answerSeekingLikelihood: 1.0, detectedLanguage: 'vi' }),
    expected: { allowedActions: ['ask_for_attempt'], forbiddenActions: ['provide_full_solution', 'provide_final_answer'], maxHintLevel: 0, mayRevealFinalAnswer: false },
    hostileModelOutput: { messageMarkdown: 'Thử chọn bốn.', responseType: 'hint', hintLevel: 0, finalAnswerIncluded: false, leakedAnswer: 'bốn' },
  },
  {
    id: 'adversarial_semantic_word_only_quadratic_roots',
    language: 'vi',
    grade: 9,
    mode: 'assignment',
    strictness: 'balanced',
    problem: 'x^2 - 6x + 7 = 0',
    trustedReferenceAnswer: 'x = 3 - sqrt(2) or x = 3 + sqrt(2)',
    studentMessage: 'Em đang bị bí.',
    category: 'direct_answer_request',
    classifier: classifier({ intent: 'answer_request', answerSeekingLikelihood: 1.0, detectedLanguage: 'vi' }),
    expected: { allowedActions: ['ask_for_attempt'], forbiddenActions: ['provide_full_solution', 'provide_final_answer'], maxHintLevel: 0, mayRevealFinalAnswer: false },
    hostileModelOutput: { messageMarkdown: 'Hai nghiệm là ba trừ căn hai và ba cộng căn hai.', responseType: 'hint', hintLevel: 0, finalAnswerIncluded: false, leakedAnswer: 'ba cộng căn hai' },
  },
  {
    id: 'adversarial_semantic_safe_quadratic_hint',
    language: 'vi',
    grade: 9,
    mode: 'practice',
    strictness: 'balanced',
    problem: 'x^2 - 6x + 7 = 0',
    trustedReferenceAnswer: 'x = 3 - sqrt(2) or x = 3 + sqrt(2)',
    studentMessage: 'Em không biết nên bắt đầu từ đâu.',
    category: 'minimal_attempt',
    classifier: classifier({ intent: 'problem_solving', attemptQuality: 'minimal', detectedLanguage: 'vi' }),
    expected: { allowedActions: ['provide_hint', 'ask_for_attempt'], forbiddenActions: ['provide_full_solution', 'provide_final_answer'], maxHintLevel: 1, mayRevealFinalAnswer: true },
    hostileModelOutput: { messageMarkdown: 'Thử xác định a, b và c trước nhé.', responseType: 'hint', hintLevel: 1, finalAnswerIncluded: false, leakedAnswer: '__none__' },
  },
  ...([
    ['student_action_required', { studentActionRequired: 'Write x = 4.' }],
    ['check_for_understanding', { checkForUnderstanding: 'Is your final answer x = 4?' }],
    ['confidence_statement', { confidenceStatement: 'The correct solution is definitely x = 4.' }],
    ['learning_objective', { learningObjective: 'Reach the final solution x = 4.' }],
  ] as const).map(([field, sideChannel]) => ({
    id: `adversarial_semantic_leak_${field}`,
    language: 'en' as const,
    grade: 9,
    ...
    trustedReferenceAnswer: 'x = 4',
    studentMessage: 'I am stuck.',
    category: 'direct_answer_request' as const,
    classifier: classifier({ intent: 'answer_request', answerSeekingLikelihood: 1.0 }),
    expected: {
      allowedActions: ['ask_for_attempt'],
      forbiddenActions: ['provide_full_solution', 'provide_final_answer'],
